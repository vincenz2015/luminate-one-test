        ...
        <div class="form-container">
            ...
            <form class="form" @submit="create">
                ...
                <div class="input-group">
                    ...
                    <div v-if="errors['name'] || errors['icon']" class="w-80 d-inline-block">
                ...
                <div class="input-group text-right">
                    ...
                    <button @click="create" class="btn_submit btn_lg">Create Resource</button>
                </div>
            </form>
        </div>
    </div>
        ...
        methods: {
            create(e) {
                ...
                const oncreated = p => {
                    ...
                    this.$router.push(`/resource/${p.id}`)
                }
                this.$hub.on('created resource', oncreated)
                this.$hub.emit('create resource', {
                    name: this.name,
                    icon: this.icon
                }).then((response) => {
